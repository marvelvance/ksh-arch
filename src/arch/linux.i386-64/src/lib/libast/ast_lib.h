/* : : generated from /home/marvel/Downloads/ksh/src/src/lib/libast/features/lib by iffe version 2013-11-14 : : */
#ifndef _def_lib_ast
...
#define _mac_AT_FDCWD	1	/* AT_FDCWD is a macro */
...
#define _lib_fdopendir	1	/* fdopendir() in default lib(s) */
...
#define _lib_fdatasync	1	/* fdatasync() in default lib(s) */
#define _lib_sync	1	/* sync() in default lib(s) */
#define _lib_syncfs	1	/* syncfs() in default lib(s) */
...
#define _lib_on_exit	1	/* on_exit() in default lib(s) */
#define _lib_opendir	1	/* opendir() in default lib(s) */
#define _lib_pathconf	1	/* pathconf() in default lib(s) */
#define _lib_fpathconf	1	/* fpathconf() in default lib(s) */
#define _lib_pipe2	1	/* pipe2() in default lib(s) */
#define _lib_qsort	1	/* qsort() in default lib(s) */
#define _lib_qsort_r	1	/* qsort_r() in default lib(s) */
...
#define _lib_stpcpy	1	/* stpcpy() in default lib(s) */
#define _lib_stpncpy	1	/* stpncpy() in default lib(s) */
...
#define _lib_accept4	1	/* accept4() in default lib(s) */
#define _lib_socketpair	1	/* socketpair() in default lib(s) */
#define _lib_faccessat	1	/* faccessat() in default lib(s) */
#define _lib_fchmodat	1	/* fchmodat() in default lib(s) */
#define _lib_fchownat	1	/* fchownat() in default lib(s) */
#define _lib_fstatat	1	/* fstatat() in default lib(s) */
#define _lib_linkat	1	/* linkat() in default lib(s) */
#define _lib_mkdirat	1	/* mkdirat() in default lib(s) */
#define _lib_mkfifoat	1	/* mkfifoat() in default lib(s) */
#define _lib_mknodat	1	/* mknodat() in default lib(s) */
#define _lib_openat	1	/* openat() in default lib(s) */
#define _lib_readlinkat	1	/* readlinkat() in default lib(s) */
#define _lib_renameat	1	/* renameat() in default lib(s) */
#define _lib_symlinkat	1	/* symlinkat() in default lib(s) */
#define _lib_unlinkat	1	/* unlinkat() in default lib(s) */
#define _lib_fstatat64	1	/* fstatat64() in default lib(s) */
#define _lib_openat64	1	/* openat64() in default lib(s) */

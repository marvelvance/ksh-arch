...
/* : : generated by proto : : */
/* : : generated from /home/marvel/Downloads/ksh/src/src/lib/libast/features/wchar by iffe version 2013-11-14 : : */
...
#define _lib_wcscmp	1	/* wcscmp() in default lib(s) */
#define _lib_wcscoll	1	/* wcscoll() in default lib(s) */
#define _lib_wcslen	1	/* wcslen() in default lib(s) */
#define _lib_wcstombs	1	/* wcstombs() in default lib(s) */
#define _lib_wcsxfrm	1	/* wcsxfrm() in default lib(s) */
#define _lib_wcwidth	1	/* wcwidth() in default lib(s) */
#define _lib_mbrlen	1	/* mbrlen() in default lib(s) */
#define _lib_mbrtowc	1	/* mbrtowc() in default lib(s) */
#define _lib_mbsrtowcs	1	/* mbsrtowcs() in default lib(s) */
#define _lib_wcrtomb	1	/* wcrtomb() in default lib(s) */
#define _lib_wcsrtombs	1	/* wcsrtombs() in default lib(s) */
...
#if !_lib_mbrlen
extern __MANGLE__ size_t		mbrlen __PROTO__((const char*, size_t, mbstate_t*));
#endif

#if !_lib_mbrtowc
extern __MANGLE__  size_t		mbrtowc __PROTO__((wchar_t*, const char*, size_t, mbstate_t*));
#endif

#if !_lib_mbsrtowcs
extern __MANGLE__  size_t		mbsrtowcs __PROTO__((wchar_t*, const char**, size_t, mbstate_t*));
#endif
...
#if !_lib_wcsrtombs
extern __MANGLE__ size_t		wcsrtombs __PROTO__((char*, const wchar_t**, size_t, mbstate_t*));
#endif

/* the remaining mb*() and wc*() functions are obsolete */

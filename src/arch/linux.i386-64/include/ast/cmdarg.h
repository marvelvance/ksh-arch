...
typedef int (*Cmdrun_f) __PROTO__((int, char**, Cmddisc_t*));
...
#endif
extern __MANGLE__ Cmdarg_t*	cmdopen_20110505 __PROTO__((char**, int, int, const char*, int, Error_f));
extern __MANGLE__ Cmdarg_t*	cmdopen_20120411 __PROTO__((char**, int, int, const char*, Cmddisc_t*));

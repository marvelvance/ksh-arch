...
typedef void (*Error_exit_f) __PROTO__((int));
typedef void (*Error_exit_handle_f) __PROTO__((__V_*, int));
typedef ssize_t (*Error_write_f) __PROTO__((int, const __V_*, size_t));
typedef ssize_t (*Error_write_handle_f) __PROTO__((__V_*, int, const __V_*, size_t));
...
struct Error_info_s			/* error state			*/
{
	...
	__V_*		handle;		/* user defined => Error_*_handle_f */
};

...
extern __MANGLE__ unsigned int		asoactivecpu __PROTO__((void));
extern __MANGLE__ int			asolock __PROTO__((unsigned int volatile*, unsigned int, int));
extern __MANGLE__ int			asorelax __PROTO__((long));
extern __MANGLE__ int			asoyield __PROTO__((void));
extern __MANGLE__ unsigned int		asothreadid __PROTO__((void));

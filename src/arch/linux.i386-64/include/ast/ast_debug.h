...
static __V_* _ast_newof __PARAM__((__V_* _ast_p, ssize_t _ast_t, ssize_t _ast_n, ssize_t _ast_x, const char* _ast_f, unsigned long _ast_l), (_ast_p, _ast_t, _ast_n, _ast_x, _ast_f, _ast_l)) __OTORP__(__V_* _ast_p; ssize_t _ast_t; ssize_t _ast_n; ssize_t _ast_x; const char* _ast_f; unsigned long _ast_l;){
	__V_*	_ast_r;
...
static __V_* _ast_oldof __PARAM__((__V_* _ast_p, ssize_t _ast_t, ssize_t _ast_n, ssize_t _ast_x, const char* _ast_f, unsigned long _ast_l), (_ast_p, _ast_t, _ast_n, _ast_x, _ast_f, _ast_l)) __OTORP__(__V_* _ast_p; ssize_t _ast_t; ssize_t _ast_n; ssize_t _ast_x; const char* _ast_f; unsigned long _ast_l;){
	__V_*	_ast_r;

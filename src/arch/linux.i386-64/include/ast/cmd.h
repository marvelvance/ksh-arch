...
extern __MANGLE__ int CMD_STANDALONE __PROTO__((int, char**, Shbltin_t*));
...
static int
cmdinit __PARAM__((int argc, register char** argv, Shbltin_t* context, const char* catalog, int flags), (argc, argv, context, catalog, flags)) __OTORP__(int argc; register char** argv; Shbltin_t* context; const char* catalog; int flags;){
	register char*	cp;
	register char*	pp;
...
extern __MANGLE__ int	_cmd_init __PROTO__((int, char**, Shbltin_t*, const char*, int));

...
extern __MANGLE__ Msg_info_t	msg_info;
...
extern __MANGLE__ int		msggetmask __PROTO__((char*, int, unsigned long));
extern __MANGLE__ int		msgindex __PROTO__((const char*));
extern __MANGLE__ int		msglist __PROTO__((Sfio_t*, Msg_call_t*, int, unsigned long));
extern __MANGLE__ const char*	msgname __PROTO__((unsigned long));
extern __MANGLE__ unsigned long	msgsetmask __PROTO__((const char*));

extern __MANGLE__ unsigned long	msggetu __PROTO__((char**, char*));
extern __MANGLE__ int		msgputu __PROTO__((char**, char*, unsigned long));
extern __MANGLE__ size_t		msggetz __PROTO__((char**, char*, __V_*, size_t));
extern __MANGLE__ int		msgputz __PROTO__((char**, char*, __V_*, size_t));

extern __MANGLE__ ssize_t		msgcall __PROTO__((int, unsigned long, unsigned long, Msg_return_t*, ...));
extern __MANGLE__ ssize_t		msgvcall __PROTO__((int, unsigned long, unsigned long, Msg_return_t*, __V_**, va_list));
extern __MANGLE__ long		msgreturn __PROTO__((int, unsigned long, ...));
extern __MANGLE__ long		msgvreturn __PROTO__((int, unsigned long, __V_**, va_list));

extern __MANGLE__ ssize_t		msgblast __PROTO__((Msg_call_t*));
extern __MANGLE__ ssize_t		msgread __PROTO__((int, char*, size_t));
extern __MANGLE__ ssize_t		msgrecv __PROTO__((int, Msg_call_t*));
extern __MANGLE__ ssize_t		msgsend __PROTO__((int, Msg_call_t*, unsigned long, long, int, __V_*));
